...
A proper name is by itself sufficient reason to capture an organization — it does NOT have to be significant, substantial, or described any further. Capture a named organization EVEN WHEN the message gives no other information about it: the name alone is enough. When you have only the name and no other facts, do not invent a factual statement — return a single entry whose "quote" is the organization's name exactly as it appears in the message (so the organization still carries that name as its one supporting quote) and whose "detail" simply identifies it as a named group. If a message is just a comma-separated list of named groups (for example, a list of sports teams), capture EACH listed name as its own name-only organization — one entry per name.
...
- A place is NOT an organization. A realm like the Krieger Imperium is captured by the locations extractor as a PLACE (its territory and geography); here you capture only the governing BODY (who rules it, how it is structured, its power). The same realm legitimately appears in both — capture only the group/governance side here.
- A single individual is NOT an organization — that is a character. "Emperor Tiberius" is a character; "the Krieger Imperium" he rules is an organization.
...
EXAMPLE
Input:
[{"id": 0, "content": "Almost every country southeast of the Cloud Mountains is under the control of the Krieger Imperium"}, {"id": 1, "content": "The Imperium is ruled by Emperor Tiberius and his war council"}, {"id": 2, "content": "Tansy's Adventuring Agency takes contracts out of Crown's Nest"}, {"id": 3, "content": "the council that rules Gol just raised taxes again"}, {"id": 4, "content": "some merchants were selling potions"}, {"id": 5, "content": "what's everyone's AC for tomorrow"}, {"id": 6, "content": "Valdenmoor Dire Wolves, Crown's Nest Crows, Cloverton Honeybees"}]
Output:
[{"name": "Krieger Imperium", "aliases": ["the Imperium"], "details": [{"detail": "Controls almost every country southeast of the Cloud Mountains", "quote": "Almost every country southeast of the Cloud Mountains is under the control of the Krieger Imperium", "source_id": 0}, {"detail": "Ruled by Emperor Tiberius and his war council", "quote": "The Imperium is ruled by Emperor Tiberius and his war council", "source_id": 1}]}, {"name": "Tansy's Adventuring Agency", "aliases": [], "details": [{"detail": "Takes contracts out of Crown's Nest", "quote": "Tansy's Adventuring Agency takes contracts out of Crown's Nest", "source_id": 2}]}, {"name": "The council of Gol", "aliases": [], "details": [{"detail": "Rules Gol and recently raised taxes", "quote": "the council that rules Gol just raised taxes again", "source_id": 3}]}, {"name": "Valdenmoor Dire Wolves", "aliases": [], "details": [{"detail": "A named group", "quote": "Valdenmoor Dire Wolves", "source_id": 6}]}, {"name": "Crown's Nest Crows", "aliases": [], "details": [{"detail": "A named group", "quote": "Crown's Nest Crows", "source_id": 6}]}, {"name": "Cloverton Honeybees", "aliases": [], "details": [{"detail": "A named group", "quote": "Cloverton Honeybees", "source_id": 6}]}]
(Notes on the example: message 3 has no proper name but is tied to a location, Gol, so it is kept with a short descriptive label "The council of Gol". Message 4 produced nothing — "some merchants" is a vague group with no name and no tie. Message 5 is game mechanics. The Krieger Imperium appears here only as the governing BODY; its territory is captured separately by the locations extractor. Message 6 is a bare comma-separated list of named groups: each name becomes its own name-only organization, carrying the name itself as its single supporting quote.)"""
